 ...
 */
MapTo('my-site-2/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('my-site-2/components/separator')(SeparatorV1Component);

MapTo('my-site-2/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('my-site-2/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('my-site-2/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('my-site-2/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('my-site-2/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('my-site-2/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('my-site-2/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('my-site-2/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('my-site-2/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('my-site-2/components/accordion')(AccordionV1Component);
MapTo('my-site-2/components/tabs')(TabsV1Component);
...
LazyMapTo('my-site-2/components/teaser')(TeaserV1Component);
...
LazyMapTo('my-site-2/components/carousel')(CarouselV1Component);
...
LazyMapTo('my-site-2/components/text')(LazyTextModule, TextEditConfig);