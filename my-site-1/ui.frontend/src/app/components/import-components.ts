 ...
 */
MapTo('my-site-1/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('my-site-1/components/separator')(SeparatorV1Component);

MapTo('my-site-1/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('my-site-1/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('my-site-1/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('my-site-1/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('my-site-1/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('my-site-1/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('my-site-1/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('my-site-1/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('my-site-1/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('my-site-1/components/accordion')(AccordionV1Component);
MapTo('my-site-1/components/tabs')(TabsV1Component);
...
LazyMapTo('my-site-1/components/teaser')(TeaserV1Component);
...
LazyMapTo('my-site-1/components/carousel')(CarouselV1Component);
...
LazyMapTo('my-site-1/components/text')(LazyTextModule, TextEditConfig);